...
#define EXAMPLE_I2S_SAMPLE_RATE   (128000)
...
#define FLASH_RECORD_SIZE         (1 * EXAMPLE_I2S_SAMPLE_RATE * EXAMPLE_I2S_SAMPLE_BITS / 8 * 5)
...
void configure_i2s(){
  i2s_config_t i2s_config = 
    ...
    .channel_format = I2S_CHANNEL_FMT_RIGHT_LEFT, //                                 // only the left channel
  ...
  if (data_partition != NULL) {
   ...
   //    WRITE_PERI_REG(SYSCON_SARADC_SAR1_PATT_TAB1_REG, 0x0F4F0F4F);
       //  WRITE_PERI_REG(SYSCON_SARADC_SAR1_PATT_TAB2_REG, 0x0F4F3F5F);
         WRITE_PERI_REG(SYSCON_SARADC_SAR1_PATT_TAB1_REG, 0x0F6F0F3F);
         WRITE_PERI_REG(SYSCON_SARADC_SAR1_PATT_TAB2_REG, 0x0F6F0F5F);
